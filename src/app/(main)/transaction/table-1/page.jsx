  ...
  return (
    <div className="p-4 sm:p-12 w-full font-normal text-sm">
      <div className="flex flex-col sm:flex-row justify-evenly ">
        ...
        <div className="widgets flex flex-row sm:flex-col w-2/5 pl-3 mt-4 sm:mt-0 sm:space-y-4">
          {/* widgets1 */}
          <div className="widget flex justify-between items-center p-6 bg-white shadow rounded-lg mr-2 sm:mr-0">
            <div className="left">
              <span className="title text-gray-500">Số lượng giao dịch</span>
              <span className="counter block text-2xl font-bold">72</span>
              <a href="#" className="link text-blue-500 hover:underline">
                Xem thêm
              </a>
            </div>
            <div className="right flex items-center">
              ...
              <svg
                className="icon w-10 h-10 fill-current text-crimson bg-red-100 rounded-full p-1 ml-4"
                focusable="false"
                aria-hidden="true"
                viewBox="0 0 24 24"
          ...
          {/* widgets2 */}
          <div className="widget flex justify-between items-center p-5 bg-white shadow rounded-lg mr-2 sm:mr-0">
            <div className="left">
            ...
            <div className="right flex items-center">
              ...
              <svg
                className="icon w-10 h-10 fill-current text-goldenrod bg-yellow-100 rounded-full p-1 ml-4"
                focusable="false"
                aria-hidden="true"
                viewBox="0 0 24 24"
          ...
          <div className="widget flex justify-between items-center p-6 bg-white shadow rounded-lg">
            ...
            <div className="right flex items-center">
              ...
              <svg
                className="icon w-10 h-10 fill-current text-green bg-green-100 rounded-full p-1 ml-4"
                focusable="false"
                aria-hidden="true"
                viewBox="0 0 24 24"
      ...
      <div className="flex space-x-4 mt-7	">
        ...
        <a
          ...
          className="pb-2 border-b-2 border-transparent hover:border-red-600">
          Giao dịch ecoin
        </a>
      </div>
