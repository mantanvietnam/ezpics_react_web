    ...
    return (
        <div className='p-12  w-full font-family-[Roboto,_Helvetica,_Arial,_sans-serif] font-normal text-sm'>
            <div className='flex justify-evenly '>
                <div class="widgets flex flex-col w-3/5 pl-3 space-y-4 bg-center">
                    {/* <p>a</p> */}
                    <ChartPage />
                </div>
                <div class="widgets flex flex-col w-2/5 pl-3 space-y-4">
                    {/* widgets1 */}
                    <div class="widget flex justify-between items-center p-6 bg-white shadow rounded-lg">
                        <div class="left">
                    ...
                    {/* widgets2 */}
                    <div class="widget flex justify-between items-center p-5 bg-white shadow rounded-lg">
                        <div class="left">
