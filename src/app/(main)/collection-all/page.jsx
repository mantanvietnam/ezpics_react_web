  ...
  useEffect(() => {
    if (!hasMoreData) {
      ...
      const fetchData = async () => {
        if (page > 1) {
          try {
            const response = await searchWarehousesAPI({
              ...searchValues,
              page,
            });
            if (response.data) {
  ...
  return (
    <div className="flex-col w-[90%] mt-5 mb-5">
      ...
      <div
        ...
        className="flex items-center justify-around gap-8 p-[20px] mobile:p-[50px] rounded-[20px] relative overflow-hidden w-full h-[200px] mobile:h-[300px]">
        ...
        <div className="w-[150px] h-[150px] mobile:w-[300px] moblile:h-[300px]">
