...
export async function generateMetadata({ params }) {
  ...
  return {
    title: product.name,
    description: `Mẫu thiết kế ${product.title} của tác giả ${product.author
      } đã bán được ${product.sold} mẫu với giá bán ${product.sale_price ? product.sale_price : "miễn phí"
      }`,
    openGraph: {
      title: product.name,
      type: "website",
