...
import { selectFonts } from "../../../../../../../redux/slices/fonts/selectors";
import { getTextOptions } from "@/utils/media/object-options";
    ...
    <div>
      ...
      <div style={{ padding: "0 1.5rem" }}>
        <Button
          size="compact"
          onClick={() =>
            handleChange("underline", activeObject.underline ? false : true)
          }
          kind="tertiary">
          <Spacing size={24} />
        </Button>
