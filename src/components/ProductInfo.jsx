    ...
    <div className='flex w-full h-[500px] mt-[100px]'>
      ...
      <div className='flex flex-col justify-between'>
        ...
        <div className='flex items-center gap-5 bg-slate-100 p-5'>
          <div className='text-3xl text-red-500'>{VND.format(data?.sale_price)}</div>
          <div className='line-through text-slate-400 rounded-sm'>{VND.format(data?.price)}</div>
          <div className='bg-red-500 text-white p-2 font-semibold rounded-sm'>Giảm {100 - (data?.sale_price / data?.price) * 100}%</div>
        </div>
